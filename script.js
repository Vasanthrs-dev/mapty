...
class App {
  ...
  _newWorkout(e) {
    const checkNum = (...num) =>
      num.every(inp => Number.isFinite(inp) && inp > 0);
    e.preventDefault();
    ...
    if (type === 'running') {
      ...
      if (!checkNum(distance, duration, cadence))
        return alert('Please enter a postive number!');
    ...
    if (type === 'cycling') {
      ...
      // Check if data is valid
      if (!checkNum(distance, duration, elevation))
        return alert('Please enter a postive number!');
